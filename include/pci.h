...
#define pci__cfg_read_vendor(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x0))
#define pci__cfg_read_device(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x2))
#define pciConfigReadCommand(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x4))
#define pciConfigReadStatus(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x6))
#define pci__cfg_read_revision(bus, slot, function) \
    (pci__cfg_read32((bus), (slot), (function), 0x8))
#define pci__cfg_read_prog_if(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x9))
#define pci__cfg_read_subclass(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xa))
#define pci__cfg_read_class(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xb))
#define pci__cfg_read_cache_line_size(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xc))
#define pci__cfg_write_cache_line_size(bus, slot, function, value) \
    (pci__cfg_write8((bus), (slot), (function), 0xc, value))
#define pciConfigReadLatencyTimer(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xd))
#define pci__cfg_read_header_type(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xe))
#define pciConfigReadBIST(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0xf))
/* With Header Type 0 there are 6 addresses starting from 0. */
#define pci__cfg_read_base_addr(bus, slot, function, address) \
    (pci__cfg_read32((bus), (slot), (function), 0x10 + 4 * (address)))
#define pci__cfg_write_base_addr(bus, slot, function, address, value) \
    (pci__cfg_write32((bus), (slot), (function), 0x10 + 4 * (address), value))
#define pciConfigReadCardbusCISPointer(bus, slot, function) \
    (pci__cfg_read32((bus), (slot), (function), 0x28))
...
#define pciConfigReadSubsystemVendor(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x2c))
#define pciConfigReadSubsystemDevice(bus, slot, function) \
    (pci__cfg_read16((bus), (slot), (function), 0x2e))
#define pciConfigReadExpansionROMBaseAddress(bus, slot, function) \
    (pci__cfg_read32((bus), (slot), (function), 0x30))
...
#define pciConfigReadCapabilitiesPointer(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x34))
#define pci__cfg_read_interrupt_line(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x3c))
#define pci__cfg_read_interrupt_pin(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x3d))
#define pci__cfg_write_interrupt_pin(bus, slot, function, value) \
    (pci__cfg_write8((bus), (slot), (function), 0x3d, value))
#define pciConfigReadMin_Gnt(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x3e))
#define pciConfigReadMax_Lat(bus, slot, function) \
    (pci__cfg_read8((bus), (slot), (function), 0x3f))

/* header type 1 */
#define pci__cfg_write_secondary_bus(bus, slot, function, value) \
    (pci__cfg_write8((bus), (slot), (function), 0x19, value))
#define pci__cfg_write_subordinate_bus(bus, slot, function, value) \
    (pci__cfg_write8((bus), (slot), (function), 0x1a, value))
#define pci__cfg_write_memory_base(bus, slot, function, value) \
    (pci__cfg_write16((bus), (slot), (function), 0x20, value))
#define pci__cfg_write_memory_limit(bus, slot, function, value) \
    (pci__cfg_write16((bus), (slot), (function), 0x20, value))
#define pci__cfg_write_bridge_control(bus, slot, function, value) \
    (pci__cfg_write8((bus), (slot), (function), 0x3e, value))

/* Macros for writing specific registers in PCI Configuration Space. */
#define pci__cfg_write_command(bus, slot, function, data) \
    (pci__cfg_write16((bus), (slot), (function), 0x4, (data)))
#define pciConfigWriteCachelineSize(bus, slot, function, data) \
    (pci__cfg_write8((bus), (slot), (function), 0xc, (data)))
#define pciConfigWriteLatencyTimer(bus, slot, function, data) \
    (pci__cfg_write8((bus), (slot), (function), 0xd, (data)))
#define pciConfigWriteBIST(bus, slot, function, data) \
    (pci__cfg_write8((bus), (slot), (function), 0xf, (data)))
/* With Header Type 0 there are 6 addresses starting from 0. */
#define pciConfigWriteBaseAddress(bus, slot, function, address, data) \
    (pci__cfg_write32((bus), (slot), (function), 0x10 + 4 * (address), (data)))
#define pciConfigWriteInterruptLine(bus, slot, function, data) \
    (pci__cfg_write8((bus), (slot), (function), 0x3c, (data)))
...
(pci__cfg_read8((bus), (slot), (function), (pointer))
#define pciConfigReadCapabilitiesNextPointer(bus, slot, function, pointer) \
(pci__cfg_read8((bus), (slot), (function), (pointer) + 1)
